# selftest: proves the export tooling is trustworthy (tools/phase1/dbmigrate/export-postgresql/CLAUDE.md, "How selftest works"). Needs the live source (LocalDB) and a

# metadata: builds source-metadata.json, the data about the SQL Server source recorded at export (tools/phase1/dbmigrate/export-postgresql/CLAUDE.md, "Contracts").

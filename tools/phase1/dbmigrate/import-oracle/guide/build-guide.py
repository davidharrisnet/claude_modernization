#!/usr/bin/python3
"""Build docs/phase1/dbmigrate/import-oracle/OracleDatabaseGuide.html from guide.tpl.html.
...
OUTPUT = os.path.join(REPO, "docs", "phase1", "dbmigrate", "import-oracle", "OracleDatabaseGuide.html")

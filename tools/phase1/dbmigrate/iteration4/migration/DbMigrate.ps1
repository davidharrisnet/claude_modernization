# Iteration 4 entry point. Normally called through tools\phase1\dbmigrate\iteration4\dbmigrate4.cmd:
...
Options:
  ...
  --config <path>   config file (default tools\phase1\dbmigrate\iteration4\migration\migration.config.json)

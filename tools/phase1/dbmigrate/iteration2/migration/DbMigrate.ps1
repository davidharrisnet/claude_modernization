# Database migration entry point. Normally called through tools\phase1\dbmigrate\iteration2\dbmigrate.cmd:
...
Options:
  ...
  --config <path>   config file (default tools\phase1\dbmigrate\iteration2\migration\migration.config.json)

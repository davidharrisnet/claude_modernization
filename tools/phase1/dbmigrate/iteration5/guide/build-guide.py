#!/usr/bin/python3
"""Build docs/phase1/dbmigrate/iteration5/PostgreSQLDatabaseGuide.html from guide.tpl.html.
...
OUTPUT = os.path.join(REPO, "docs", "phase1", "dbmigrate", "iteration5", "PostgreSQLDatabaseGuide.html")

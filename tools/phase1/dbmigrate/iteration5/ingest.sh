...
REPORT_DIR="$REPO_ROOT/docs/phase1/dbmigrate/iteration5"
...
Commands:
  ...
  report    build docs/phase1/dbmigrate/iteration5/MigrationVerificationReport5.html from the results JSON

...
- Plan: `docs/phase1/dbmigrate/iteration5/ITERATION5_PLAN.md`. Record of the real run: `docs/phase1/dbmigrate/iteration5/ITERATION5.md`.
...
| `report` | Builds `docs/phase1/dbmigrate/iteration5/MigrationVerificationReport5.html` from the two results files (rendered by `psql` in the container's `postgres` database; the migrated data is not read). |
...
The full guide, including application logins, network routes and a Spring Boot project, is `docs/phase1/dbmigrate/iteration5/PostgreSQLDatabaseGuide.html`. The quick version:

...
DOCS_DIR = HERE.parent.parent.parent.parent / "docs/phase1/dbmigrate/iteration3"
...
def main():
    ...
    md.append("From `tools/phase1/dbmigrate/iteration3/` on a Linux host with Docker:\n")

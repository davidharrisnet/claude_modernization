...
Writes tools/phase1/dbmigrate/iteration3/verification-results.json. Exit codes:
...
def git_commit():
    r = sh(["git", "-C", str(HERE.parent.parent.parent.parent), "rev-parse", "--short", "HEAD"], check=False)

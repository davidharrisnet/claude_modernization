#!/usr/bin/env bash
# import-postgresql: load the PostgreSQL export from export-postgresql into a PostgreSQL Docker container and verify it against
# source-metadata.json. bash + Docker only: psql runs inside the container; no host psql, Python, Java or jq.
# Instructions: CLAUDE.md in this folder. Description: ../../../../docs/phase1/dbmigrate/import-postgresql/README.md
#
...
REPORT_DIR="$REPO_ROOT/docs/phase1/dbmigrate/import-postgresql"
...
Commands:
  ...
  report    build docs/phase1/dbmigrate/import-postgresql/MigrationVerificationReport.html from the results JSON

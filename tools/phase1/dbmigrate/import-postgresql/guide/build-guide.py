#!/usr/bin/python3
"""Build docs/phase1/dbmigrate/import-postgresql/PostgreSQLDatabaseGuide.html from guide.tpl.html.
...
OUTPUT = os.path.join(REPO, "docs", "phase1", "dbmigrate", "import-postgresql", "PostgreSQLDatabaseGuide.html")

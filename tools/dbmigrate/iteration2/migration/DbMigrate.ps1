# Database migration entry point. Normally called through tools\dbmigrate\iteration2\dbmigrate.cmd:
...
Options:
  ...
  --config <path>   config file (default tools\dbmigrate\iteration2\migration\migration.config.json)

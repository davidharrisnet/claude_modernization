...
<pre><code>tools/dbmigrate/iteration5/ingest.sh all --recreate   # load, verify, selftest, report
tools/dbmigrate/iteration5/ingest.sh verify           # re-check the running database
...
|| '</dl></section>
<footer><p>Generated by <code>tools/dbmigrate/iteration5/ingest.sh report</code> from <code>verification-results.json</code> and <code>selftest-results.json</code>. Plan: <code>docs/dbmigrate/iteration5/ITERATION5_PLAN.md</code>; record: <code>docs/dbmigrate/iteration5/ITERATION5.md</code>.</p></footer>
</main>
</body>
</html>'
FROM r;

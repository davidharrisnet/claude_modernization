-- Iteration 5 verification: checks the loaded PostgreSQL database against source-metadata.json.
...
-- Canonical form (defined by iteration 4, independent of any database): per table, rows sorted by their own text in
...
-- The PostgreSQL form of the ten summaries from the earlier iterations (the metadata's sourceSql is SQL Server text,

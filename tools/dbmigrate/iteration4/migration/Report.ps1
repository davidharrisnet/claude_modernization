# report: builds the Word EXPORT report (MigrationExportReport4.docx, with charts) from source-metadata.json only.
...
# The helpers below are copied from iteration 2's Report.ps1.

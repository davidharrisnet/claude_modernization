# Database migration entry point. Normally called through tools\dbmigrate\dbmigrate.cmd:
...
Options:
  ...
  --config <path>   config file (default tools\dbmigrate\migration\migration.config.json)
